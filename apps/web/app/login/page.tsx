  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-6 px-6 text-center">
      ...
      <a
        ...
        className="animate-neon-pulse rounded-lg border border-arcana-pink/60 bg-arcana-pink/10 px-6 py-3 text-sm font-semibold uppercase tracking-wide text-arcana-pink shadow-neon-pink-sm transition-all hover:bg-arcana-pink/20 hover:shadow-neon-pink"
      >
